    ...
    <section class="bg-gray-50">
      <div class="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-screen lg:items-center">
        <div class="mx-auto max-w-xl text-center">
          ...
          <form class="space-y-4 font-[sans-serif] max-w-md mx-auto" id="myForm" method="post" action="/server" onSubmit={handleSubmit} ref={formRef}>
            <div class="max-w-md mx-auto font-[sans-serif]">
              <labe class="mb-2 text-sm text-black block">Enter Domain  Like: www.xxx.com</labe>

              <div class="relative flex items-center h-12 border-2 border-[#007bff] rounded">
                <div class="bg-[#007bff] w-16 h-full flex items-center justify-center">
                ...
                <input type='text' placeholder='Enter name'
                  class="text-sm text-black rounded bg-white w-full h-full  outline-none px-4"
                  id="domainname"
                  name="name"
                  required
                  value={domainName}
